  ...
  return (
      <div className="flex w-full justify-around items-center">
        <div className="flex mf:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4">
          <div className="flex flex-1 justify-start flex-col mf:mr-10 mr-36">
            ...
            <button 
              ...
              className="flex flex-row justify-center items-center my-5 bg-[#1e3070] p-3 rounded-full cursor-pointer hover:bg-[#121e4b]"
          ...
          <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
            <div className="p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-77 w-full my-5 eth-card white-glassmorphism">
              <div className="flex justify-between flex-col w-full h-full">
                <div className="flex justify-between items-start">
                  <div className="w-10 h-10 rounded-full border-2 border-right flex justify-center items-center">
            ...
            <div className="p-5 blue-glassmorphism  sm:w-96 w-full flex flex-col justify-start items-center">
